...
export const Goods: IGoods[] = [
	...
	},
	{
		...
		program: [
			...
			'Оказание первой помощи при при ожогах',
			'Оказание первой помощи при при переохлаждении и перегревании',
			'Оказание первой помощи при при острых отравлениях',
		],
	},
	{
		id: 4,
		...
		program: [
			...
			'Оказание первой помощи при остановке дыхания и кровообращения',
			'Оказание первой помощи при наружных кровотечениях',
			'Оказание первой помощи при травмах и ранениях',
		],
	},
	{
		id: 5,
